...
export class CustomizerSettingsService {
  constructor() {
    if (this.isBrowser()) {
      ...
      // Card Bordered
      this.isCardBorderedTheme = JSON.parse(
        localStorage.getItem('isCardBorderedTheme')!
      );

      // Card Without Border Radius
      this.isCardWithoutBorderRadiusTheme = JSON.parse(
        localStorage.getItem('isCardWithoutBorderRadiusTheme')!
      );

      // Card With Box Shadow
      this.isCardWithBoxShadowTheme = JSON.parse(
        localStorage.getItem('isCardWithBoxShadowTheme')!
      );
  ...
  toggleCardBorderedTheme() {
    ...
    localStorage.setItem(
      'isCardBorderedTheme',
      JSON.stringify(this.isCardBorderedTheme)
    );
  }
  isCardBordered() {
  ...
  toggleCardWithoutBorderRadiusTheme() {
    ...
    localStorage.setItem(
      'isCardWithoutBorderRadiusTheme',
      JSON.stringify(this.isCardWithoutBorderRadiusTheme)
    );
  }
  ...
  toggleCardWithBoxShadowTheme() {
    ...
    localStorage.setItem(
      'isCardWithBoxShadowTheme',
      JSON.stringify(this.isCardWithBoxShadowTheme)
    );
  }
  isCardWithBoxShadow() {
